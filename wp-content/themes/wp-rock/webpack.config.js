...
const projectPaths = {
    ...
    // projectJsAloneBlockPath: path.resolve(__dirname, 'src/js/alone-blocks'),
 ...
 * @param {Object} entryPointsData - Data for generating entry points
 * @returns {Object} The generated entry points
 */
...
const entryPoints = [
    ...
    // {
    //     path: projectPaths.projectJsAloneBlockPath,
    //     ext: 'js',
    //     prefix: 'js-',
    // },
    {
